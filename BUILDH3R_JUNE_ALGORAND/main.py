...
print("Pre Clawback Receiver Account Asset Balance",algorand.account.get_information(receiver_acct.address)["assets"][0]['amount'])
print("Post Clawback Creator Account Asset Balance",algorand.account.get_information(creator.address)["assets"][0]['amount'])